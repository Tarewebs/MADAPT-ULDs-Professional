...
if (basename((string)($_SERVER['SCRIPT_NAME'] ?? '')) === 'index.php') {
    ob_start(static function (string $html): string {
        ...
        if (stripos($html, 'href="operations-ui.php"') === false && preg_match('/(<nav[^>]*>)(.*?)(<\/nav>)/is', $html, $nav)) {
            $link = '<a class="madapt-operations-link" href="operations-ui.php" aria-label="OPERACIONES">✈ <span>OPERACIONES</span></a>';
